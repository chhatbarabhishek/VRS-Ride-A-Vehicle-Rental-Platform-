<?php 
  // session_start();
  $IsLogin = isset($_SESSION['login_user']);
?>
<style>
    /* Profile Section in Navigation Bar */
.nav-list .nav-item span {
    font-weight: bold;
    color: #ffd700;  /* You can adjust the color */
    font-size: 10px;
    margin-right: -30px;
}
  ...
  <ul class="nav-list">
    ...
    <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="background-color: #ffffff; border: 2px solid #23393d;">
      ...
      <?php if (!$IsLogin): ?>
        ...
        <li class="nav-item">
          <a class="nav-link" href="#" id="call">Login</a>
        </li>
      <?php else: ?>
        <!-- Display the profile section for logged-in users -->
        ...
        <li class="nav-item">
            <span class="nav-link">
                Welcome,<br> <?php echo $_SESSION['login_user']; ?>
            </span>
        </li>
      <?php endif; ?>
  </ul>
...
<div class="modal" id="registerModal" style="display: none;">
  <div class="modal-content">
      ...
      <form action="" method="post">
          ...
          <button type="submit" class="btn" name="register">Register</button>  <!-- Changed from Sign Up to Register -->
      </form>
      <br/>
